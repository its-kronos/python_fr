...
export default function Code(){
    ...
    <div className="Content">
        ...
        <textarea className="form-control" placeholder="Entrez code ici..." spellCheck={false} onChange={(e)=>setUserCode(e.target.value)}></textarea>
        ...
        <div className="vh25 p-3 border bg-light text-wrap rounded">
            <pre>
                {outputText}
            </pre>
        </div>
